...
export default function CheckoutModal() {
    ...
    return (
        <>
            ...
            <div className="w-full h-full flex justify-center items-center fixed inset-0 z-30 px-5 md:px-0">
                <div className="w-full md:w-1/2 xl:w-1/4 bg-[#ffffff] px-5 pt-5 pb-10">
