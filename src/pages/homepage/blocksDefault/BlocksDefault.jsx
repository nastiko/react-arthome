    ...
    return (
        <>
            <section className="mx-auto max-w-screen-xl px-5 py-10 md:py-[70px] xl:px-0">
                ...
                <div
                    className="mx-auto grid max-w-screen-xl grid-cols-1 grid-rows-1 justify-center xl:justify-items-center gap-y-10 md:gap-x-6 md:gap-y-11 lg:grid-cols-2 xl:grid-cols-3">
                    {posts?.map((item, i) =>
                        <BlockItemRender
                            key={item.id}
                            {...item}
                ...
                {isLoading && (
                    <div className="max-w-screen-xl flex justify-center items-center px-5 xl:px-0 mx-auto my-8">
                        <div
